...
import UkPriorityKeywordsRow from "@/components/UkPriorityKeywordsRow";

export default function UkLandingExtras() {
  const { locale, t } = useLanguage();
  if (locale !== "uk") return null;

  const stats = [
    { value: t("ukLanding.stat1Value"), label: t("ukLanding.stat1Label") },
    { value: t("ukLanding.stat2Value"), label: t("ukLanding.stat2Label") },
    { value: t("ukLanding.stat3Value"), label: t("ukLanding.stat3Label") },
    { value: t("ukLanding.stat4Value"), label: t("ukLanding.stat4Label") },
  ];

  const steps = [
    { n: "1", title: t("ukLanding.step1Title"), body: t("ukLanding.step1Body") },
    { n: "2", title: t("ukLanding.step2Title"), body: t("ukLanding.step2Body") },
    { n: "3", title: t("ukLanding.step3Title"), body: t("ukLanding.step3Body") },
  ];

  return (
    <>
      <section
        aria-label="IPTV UK service highlights"
        className="border-y border-gray-100 bg-gradient-to-b from-slate-50/50 to-white py-10 sm:py-12"
      >
