...
export const installationSlugMap: Record<string, Record<Locale, string>> = {
  ...
  'iptv-installation-firestick': {
    ...
    uk: 'iptv-installation-firestick',
